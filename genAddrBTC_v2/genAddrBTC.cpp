...
void hiiu_decodeBech32(const char* addr,  uint32_t* _hash160) {
    ...
    printf("\nhash160: ");
    for (size_t i = 0; i < witdata_len; i++) {
        printf("%02x", hash[i]);
    }
...
void listAddr_to_arrData(){
    ...
    if (fileData.is_open()) {
        while (getline(fileData, addrLine)) {
            std::cout << "\n------------------";
            trim(addrLine);  // Trim the addrLine to remove extra spaces or newlines
	...
	printf("\n===========================================================\n");
	printf("\n===========================================================\n");
	for (int i = 0; i < n_P2PKH ; i++){	
		if (i == 0){ printf("\n ------------------> arrData_P2PKH[%d] : %d ",i , arrData_P2PKH[i]); }
		
		printf("\n ==> arrData_P2PKH[%d] : %d ",5 * i + 1 , arrData_P2PKH[5 * i + 1]); 
		printf("\n ==> arrData_P2PKH[%d] : %d ",5 * i + 2 , arrData_P2PKH[5 * i + 2]); 
		printf("\n ==> arrData_P2PKH[%d] : %d ",5 * i + 3 , arrData_P2PKH[5 * i + 3]); 
		printf("\n ==> arrData_P2PKH[%d] : %d ",5 * i + 4 , arrData_P2PKH[5 * i + 4]); 
		printf("\n ==> arrData_P2PKH[%d] : %d \n",5 * i + 5 , arrData_P2PKH[5 * i + 5]); 
	};

	printf("\n");

	for (int i = 0; i < n_P2SH ; i++){	
		if (i == 0){ printf("\n ------------------> n_P2SH[%d] : %d ",i , arrData_P2SH[i]); }
		
		printf("\n ==> n_P2SH[%d] : %d ",5 * i + 1 , arrData_P2SH[5 * i + 1]); 
		printf("\n ==> n_P2SH[%d] : %d ",5 * i + 2 , arrData_P2SH[5 * i + 2]); 
		printf("\n ==> n_P2SH[%d] : %d ",5 * i + 3 , arrData_P2SH[5 * i + 3]); 
		printf("\n ==> n_P2SH[%d] : %d ",5 * i + 4 , arrData_P2SH[5 * i + 4]); 
		printf("\n ==> n_P2SH[%d] : %d \n",5 * i + 5 , arrData_P2SH[5 * i + 5]); 
	};

	printf("\n");

	for (int i = 0; i < n_BECH32 ; i++){	
		if (i == 0){ printf("\n ------------------> n_BECH32[%d] : %d ",i , arrData_BECH32[i]); }
		
		printf("\n ==> n_BECH32[%d] : %d ",5 * i + 1 , arrData_BECH32[5 * i + 1]); 
		printf("\n ==> n_BECH32[%d] : %d ",5 * i + 2 , arrData_BECH32[5 * i + 2]); 
		printf("\n ==> n_BECH32[%d] : %d ",5 * i + 3 , arrData_BECH32[5 * i + 3]); 
		printf("\n ==> n_BECH32[%d] : %d ",5 * i + 4 , arrData_BECH32[5 * i + 4]); 
		printf("\n ==> n_BECH32[%d] : %d \n",5 * i + 5 , arrData_BECH32[5 * i + 5]); 
	};
...
int main()
{
	...
	std::string aa;
	aa = bitcoin.hash160ToAddr(BECH32, h, isCompressed);
